# DiseaseDetectionApp/test_train_model.py
# Test script for the model training functionality
...
def test_prepare_dataset():
    ...
    # Test that function returns True when diseases directory exists
    ...
    # Check that class subdirectories exist
...
def test_train_model_quick():
    ...
    # Patch the EPOCHS to 1 for quick testing
    ...
    # Check that class mapping file was created
    ...
    # Verify class mapping is valid JSON
